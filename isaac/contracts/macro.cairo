...
from starkware.cairo.common.math import (
    signed_div_rem, sign, assert_nn, assert_not_zero, unsigned_div_rem, sqrt)
...
#
func rk4{syscall_ptr : felt*, range_check_ptr}(dt : felt, state : Dynamics) -> (
        state_nxt : Dynamics):
    alloc_locals
...
#
func differentiate{syscall_ptr : felt*, range_check_ptr}(state : Dynamics) -> (
        state_diff : Dynamics):
    alloc_locals
...
func distance_cube{range_check_ptr}(pos0 : Vec2, pos1 : Vec2) -> (res : felt):
    alloc_locals
...
func forward_world_macro{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        state : Dynamics, phi : felt) -> (state_nxt : Dynamics, phi_nxt : felt):
    alloc_locals
...
#
func dynamics_mul_scalar_fp{range_check_ptr}(dynamics : Dynamics, scalar_fp : felt) -> (
        res : Dynamics):
    alloc_locals
