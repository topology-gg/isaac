...
//
namespace ns_perlin {
    func random_vector_lookup{range_check_ptr}(element_type: felt, idx: felt) -> (rv: Vec2) {
        alloc_locals;
    ...
    func get_offset{range_check_ptr}(element_type: felt) -> (offset: felt) {
        if (element_type == ns_element_types.ELEMENT_FE_RAW) {
            return (9,);
        }
...
func transformer_device_type_to_element_types{}(device_type: felt) -> (
    element_type_before_transform: felt, element_type_after_transform: felt
) {
    alloc_locals;

    if (device_type == ns_device_types.DEVICE_FE_REFN) {
        return (ns_element_types.ELEMENT_FE_RAW, ns_element_types.ELEMENT_FE_REF);
    }

    if (device_type == ns_device_types.DEVICE_AL_REFN) {
        return (ns_element_types.ELEMENT_AL_RAW, ns_element_types.ELEMENT_AL_REF);
    }

    if (device_type == ns_device_types.DEVICE_CU_REFN) {
        return (ns_element_types.ELEMENT_CU_RAW, ns_element_types.ELEMENT_CU_REF);
    }

    if (device_type == ns_device_types.DEVICE_SI_REFN) {
        return (ns_element_types.ELEMENT_SI_RAW, ns_element_types.ELEMENT_SI_REF);
    }

    if (device_type == ns_device_types.DEVICE_PEF) {
        return (ns_element_types.ELEMENT_PU_RAW, ns_element_types.ELEMENT_PU_ENR);
    }
