...
from contracts.design.constants import ns_element_types, ns_device_types, ns_energy_requirements

//
// Functions involved in recipes for device manufacturing at UPSF
//
namespace ns_manufacturing {
    func get_resource_energy_requirement_given_device_type{
        syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
    }(device_type: felt) -> (energy: felt, resource_arr_len: felt, resource_arr: felt*) {
        //
        // SPG
        //
        if (device_type == ns_device_types.DEVICE_SPG) {
            ...
            return (ns_energy_requirements.DEVICE_SPG, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_NPG) {
            ...
            return (ns_energy_requirements.DEVICE_NPG, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_FE_HARV) {
            ...
            return (ns_energy_requirements.DEVICE_FE_HARV, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_AL_HARV) {
            ...
            return (ns_energy_requirements.DEVICE_AL_HARV, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_CU_HARV) {
            ...
            return (ns_energy_requirements.DEVICE_CU_HARV, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_SI_HARV) {
            ...
            return (ns_energy_requirements.DEVICE_SI_HARV, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_PU_HARV) {
            ...
            return (ns_energy_requirements.DEVICE_PU_HARV, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_FE_REFN) {
            ...
            return (ns_energy_requirements.DEVICE_FE_REFN, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_AL_REFN) {
            ...
            return (ns_energy_requirements.DEVICE_AL_REFN, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_CU_REFN) {
            ...
            return (ns_energy_requirements.DEVICE_CU_REFN, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_SI_REFN) {
            ...
            return (ns_energy_requirements.DEVICE_SI_REFN, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_PEF) {
            ...
            return (ns_energy_requirements.DEVICE_PEF, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_UTB) {
            ...
            return (ns_energy_requirements.DEVICE_UTB, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_UTL) {
            ...
            return (ns_energy_requirements.DEVICE_UTL, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_UPSF) {
            ...
            return (ns_energy_requirements.DEVICE_UPSF, ns_element_types.ELEMENT_COUNT, arr);
        }
        ...
        if (device_type == ns_device_types.DEVICE_NDPE) {
            ...
            return (ns_energy_requirements.DEVICE_NDPE, ns_element_types.ELEMENT_COUNT, arr);
        }
