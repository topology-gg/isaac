...
@view
func mock_is_valid_grid{range_check_ptr}(grid: Vec2) -> () {
    is_valid_grid(grid);
...
@view
func mock_are_contiguous_grids_given_valid_grids{range_check_ptr}(grid0: Vec2, grid1: Vec2) -> () {
...
@view
func mock_locate_face_and_edge_given_valid_grid{range_check_ptr}(grid: Vec2) -> (
