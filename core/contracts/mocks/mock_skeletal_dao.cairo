...
func subject_report_play{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    //
    recurse_issue_new_vote_given_play(arr_play_len, arr_play, 0);

    return ();
}

func recurse_issue_new_vote_given_play{
    syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
}(arr_play_len: felt, arr_play: Play*, idx: felt) -> () {
    alloc_locals;
    ...
    // Tail recursion
    //
    recurse_issue_new_vote_given_play(arr_play_len, arr_play, idx + 1);
    return ();
}
