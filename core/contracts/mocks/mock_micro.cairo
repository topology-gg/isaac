...
from contracts.util.structs import MicroEvent, Vec2
...
func mock_device_deploy{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    caller: felt, type: felt, grid: Vec2
) -> () {
...
func mock_utb_deploy{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    caller: felt, locs_len: felt, locs: Vec2*, src_device_grid: Vec2, dst_device_grid: Vec2
) -> () {
    utb_deploy(caller, locs_len, locs, src_device_grid, dst_device_grid);
...
func mock_utb_tether_by_grid{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    caller: felt, utb_grid: Vec2, src_device_grid: Vec2, dst_device_grid: Vec2
) -> () {
    utb_tether_by_grid(caller, utb_grid, src_device_grid, dst_device_grid);
...
func mock_are_resource_producer_consumer_relationship{range_check_ptr}(
    ...
    are_resource_producer_consumer_relationship(device_type0, device_type1);
