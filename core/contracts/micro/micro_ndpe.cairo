...
from contracts.design.constants import SCALE_FP, ns_ndpe_impulse_function
from contracts.util.structs import Vec2, Dynamics
from contracts.macro.macro_simulation import mul_fp, div_fp, div_fp_ul, sqrt_fp

//#############################

func compute_impulse_in_micro_coord{range_check_ptr}(energy_consumed: felt, face: felt) -> (
    impulse_fp: Vec2
) {
    alloc_locals;
    ...
    let bool_3 = is_le(ns_ndpe_impulse_function.X_THRESH_2_3, energy_consumed);
    let bool_2 = is_nn_le(
