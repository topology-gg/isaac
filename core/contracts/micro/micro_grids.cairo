...
from contracts.micro.micro_state import ns_micro_state_functions, GridStat
...
namespace ns_micro_grids {
    ...
    //
    func get_resource_concentration_at_grid{
        syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
    }(grid: Vec2, resource_type: felt) -> (resource_concentration: felt) {
        alloc_locals;
