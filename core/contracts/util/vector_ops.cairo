...
from contracts.design.constants import SCALE_FP

//
// Function for calculating squared distance between two Vec2
//
func distance_2{range_check_ptr}(pos0: Vec2, pos1: Vec2) -> (res: felt) {
    alloc_locals;
...
//
func distance_3{range_check_ptr}(pos0: Vec2, pos1: Vec2) -> (res: felt) {
    alloc_locals;
...
func dot_fp{range_check_ptr}(v1: Vec2, v2: Vec2) -> (dot: felt) {
...
func magnitude_fp{range_check_ptr}(v: Vec2) -> (mag: felt) {
...
func compute_vector_rotate{range_check_ptr}(vec: Vec2, phi: felt) -> (vec_rotated: Vec2) {
    alloc_locals;
    ...
    let vec_rotated: Vec2 = Vec2(x_mul_cos - y_mul_sin, x_mul_sin + y_mul_cos);

    return (vec_rotated,);
}

func compute_vector_rotate_90{range_check_ptr}(vec: Vec2) -> (vec_rotated: Vec2) {
    //
    // Apply rotation matrix
    // [[0 -1],
    //  [1  0]]
